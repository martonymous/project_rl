        ...
        if multiprocessing:
            ...
            for i in range(simulations):
                ...
                '''if checkpoints and (i % checkpoint_save_every == 0) and phase_bins:
                    save_model(agent, np.digitize(i, phase_bins), unique_id)
            if not checkpoints:
                save_model(agent, i, unique_id)'''
...
if __name__ == "__main__":
    ...
    if not eval:
        ...
        df.to_csv('data/eval_q_agent_hour.csv')